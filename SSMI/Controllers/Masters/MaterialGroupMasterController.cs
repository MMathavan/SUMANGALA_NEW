...
namespace ATIMES_ERP.Controllers.Masters
{
    ...
    public class MaterialGroupMasterController : Controller
    {
        ...
        {
            return View(context.materialgroupmasters.ToList());//---Loading Grid
        }
        ...
        public JsonResult GetAjaxData(JQueryDataTableParamModel param)
        {
            using (var e = new NATIMES_ERPEntities())
            {
                ...
                var data = e.pr_SearchMaterialGroupMaster(param.sSearch,
                                                ...
                                                totalRowsCount,
                                                filteredRowsCount);
                var aaData = data.Select(d => new { MTRLGCODE = d.MTRLGCODE, MTRLGDESC = d.MTRLGDESC, DISPSTATUS = d.DISPSTATUS.ToString(), MTRLGID = d.MTRLGID.ToString() }).ToArray();
                return Json(new
                {
                    //sEcho = param.sEcho,
                    data = aaData
        ...
        [Authorize(Roles = "MaterialGroupMasterEdit")]
        public void Edit(int id)
        {
            Response.Redirect(@Url.Action("Form", "MaterialGroupMaster") + "/" + id);
        }


        //----------------Initializing Form-----------------------//
        [Authorize(Roles = "MaterialGroupMasterCreate")]
        public ActionResult Form(int? id = 0)
        {
            ...
            if (id != 0 && id != -1)  // IMP  
            {
                ...
                tab = context.materialgroupmasters.Find(id);
        ...
        public void savedata(MaterialGroupMaster tab)
        {

            var s = tab.MTRLGDESC;//...ProperCase
            ...
            {
                context.materialgroupmasters.Add(tab);
                context.SaveChanges();
            }
        ...
        public void Del()
        {
            ...
            {
                MaterialGroupMaster materialgroupmasters = context.materialgroupmasters.Find(Convert.ToInt32(id));
                context.materialgroupmasters.Remove(materialgroupmasters);
                context.SaveChanges();
