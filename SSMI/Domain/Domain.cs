...
namespace SSMI
{
    ...
    public class MenuNavData
    {
        ...
        public IEnumerable<MenuNavbar> navbarItems()
        {
            ...
            //var query = context.Database.SqlQuery<MenuRoleMaster>("select * from MenuRoleMaster where Roles='admin'");
            var query = context.Database.SqlQuery<MenuRoleMaster>("select * from MenuRoleMaster where MenuGIndex > 0 and Roles='" + System.Web.HttpContext.Current.Session["CUSRID"].ToString() + "'");
